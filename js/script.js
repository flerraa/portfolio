...
// Additional JavaScript functions for portfolio functionality
...
document.addEventListener('DOMContentLoaded', function() {
    console.log("Page loaded, checking contact section...");
    const contactSection = document.getElementById('contact');
    if (contactSection) {
        console.log("Contact section found:", contactSection);
        // Keep the working fixed positioning approach
        ...
        contactSection.style.zIndex = '9999';
        contactSection.style.background = 'transparent'; // Beautiful transparent instead of red
        contactSection.style.display = 'flex';
        contactSection.style.opacity = '0'; // Start hidden
        console.log("Contact positioned as beautiful fixed overlay");
    } else {
        console.log("Contact section NOT found! Check HTML structure.");
    }
});

// Simple and direct approach - show contact in night scene
window.addEventListener('scroll', function() {
    ...
    const contactSection = document.getElementById('contact');
    if (contactSection) {
        // Show contact when in night scene (70% or more scroll)
        if (scrollPercent >= 70) {
            contactSection.style.opacity = '1';
            contactSection.style.display = 'flex';
            contactSection.style.visibility = 'visible';
            contactSection.style.position = 'fixed'; // Keep fixed position that works
            contactSection.style.zIndex = '9999';
            console.log("✅ Contact shown at " + Math.round(scrollPercent) + "% scroll");
        } else if (scrollPercent < 65) {
            // Hide contact during day/sunset scenes  
            contactSection.style.opacity = '0';
            contactSection.style.visibility = 'hidden';
            console.log("❌ Contact hidden at " + Math.round(scrollPercent) + "% scroll");
        }
    }
});
